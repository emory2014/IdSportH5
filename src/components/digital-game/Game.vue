    ...
    <ul class="rule-ul">
        ...
        <li>
         ...
         <li>
            ...
            <p class="text">
                  Jika ada pelanggaran terhadap partisipasin dalam permainan, Danaunta berhak membatalkan partisipasin dari event, dan jika perlu berhak untuk mengambil langkah hukum;
            </p>
        </li>
         <li>
